#ifndef SUDOKU_OPTIMIZED_V2_H
#define SUDOKU_OPTIMIZED_V2_H

#include "sudoku.h"
/*
 * Solves the Sudoku puzzle. The optimized function (v2) of the "solve" function
