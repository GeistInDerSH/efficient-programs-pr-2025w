#ifndef SUDOKU_OPTIMIZED_V5_H
#define SUDOKU_OPTIMIZED_V5_H

#include "sudoku.h"
/*
 * Solves the Sudoku puzzle. The optimized function (v5) of the "solve" function
