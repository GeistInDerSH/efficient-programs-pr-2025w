#ifndef SUDOKU_OPTIMIZED_V4_H
#define SUDOKU_OPTIMIZED_V4_H

#include "sudoku.h"
/*
 * Solves the Sudoku puzzle. The optimized function (v4) of the "solve" function
